...
pub fn bind_sqlite_value<'q>(query: SqliteQuery<'q>, value: &'q Value) -> Result<SqliteQuery<'q>> {
    let query = match value {
        ...
        Value::Float(Some(v)) => query.bind(f64::from(*v)),
